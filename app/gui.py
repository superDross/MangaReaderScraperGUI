...
from MangaReaderScraper.scraper.__main__ import download_manga
from MangaReaderScraper.scraper.parsers.mangareader import MangaReader
from MangaReaderScraper.scraper.tables import TableProducer
